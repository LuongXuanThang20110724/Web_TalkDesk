        ...
        <div id="numbers">
            ...
            <div className='main-content'>
                ...
                <div style={{
                    ...
                    backgroundColor: "#E0E0E0", margin: "0 60px 0 40px"
                }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", alignContent: "center", margin: "60px -80px 0 0" }}>
                        {dataStatusOfAgents.map((item) => {
                            return (
                                <div style={{ display: "flex", margin: "0px 80px 0 0px", width: "400px" }}>
                                    <p style={{background: "#A0A0A0", color: "#ffffff", height: "30px",
                                                margin: "6px 0 0 2px", padding: "10px 6px 0 6px"}}>
                                        {item.infor}
                                    </p>
                                    <i class="fa-solid fa-square" style={{ color: item.color, margin: "18px 20px 0 20px" }}></i>
                                </div>
                            )
                        })}
                    </div>
                ...
                <div style={{ display: "flex", alignContent: "center", justifyContent: "center" }}>
                    {dataFooter.map((value) => {
                        return (
                            <p style={{ padding: "40px 100px 100px 0" }}>{value}</p>
                        )
                    })}
                </div>
