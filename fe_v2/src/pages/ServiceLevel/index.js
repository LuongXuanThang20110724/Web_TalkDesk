    ...
    return (
        <div id="serviceLevel">
            ...
            <div className='main-content'>
                <SubNavbar />
                <Feature2
                    text="Inbound Service Level Metrics"
                />
                    ...
                    {dataTimes.map((dataTime) => {
                        return (
                            <div style={{ padding: "0 100px 0 100px" }}>
                                <p style={{ fontSize: "30px", fontWeight: "600" }}>{dataTime.value}</p>
                                <div style={{ display: "flex", marginTop: "-20px", paddingBottom: "60px" }}>
                                    <p style={{ fontSize: "12px" }}>{dataTime.label}</p>
                                    <i class="fa-solid fa-circle-info"
                                        style={{ color: "#c0c0c0", padding: "10px 0 0 10px" }}></i>
                                </div>
                            </div>
                        )
                    })}
